...
const ReleaseUrl = "https://api.github.com/repos/AmizRm/Ventord/releases/latest"
const ReleaseUrlFallback = "https://vencord.dev/releases/vencord"
const InstallerReleaseUrl = "https://api.github.com/repos/AmizRm/Installer/releases/latest"
const InstallerReleaseUrlFallback = "https://vencord.dev/releases/installer"

var UserAgent = "VentordInstaller/" + buildinfo.InstallerGitHash + " (https://github.com/AmizRm/Installer)"
